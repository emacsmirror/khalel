...
After each capture, I prefer the file with upcoming events to be updated
automatically as this is a quick process:
#+begin_src emacs-lisp
(setq khalel-update-upcoming-events-after-capture 't)
#+end_src
